...
##########       ShapleyMBO     ######################
######################################################
#- other than the _seedOnce version we set the same seed in each iteration s.t. 
#  teh Shapley Settings (dataDesign) are the same in each iteration
#- we control for the ucertainty in the estimation using phi.var
